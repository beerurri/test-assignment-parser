"""Утилита, повторяющая GET-запрос с экспоненциальным бэкоффом.

При статусе 429 будет сделано до MAX_RETRIES попыток с
растущими задержками, остальные коды возвращают исключение.
"""
